...
\title{Schrödinger equation is equivalent to information conservation}\author{Gabriele Carcassi}\category{Quantum mechanics}\tags{Schrödinger equation, entropy, unitary evolution}
\begin{document}
	\maketitle
