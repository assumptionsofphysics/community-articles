...
\begin{condition}[Schrödinger equation]{DR-SCEQ}
	The evolution follows the equation $i\hbar \frac{d}{dt}\psi(t) = H(t)\psi(t)$, where $H(t)$ is a sufficiently regular family of self-adjoint
	operators so that the equation admits a differentiable unitary propagator (i.e. a solution).
\end{condition}
