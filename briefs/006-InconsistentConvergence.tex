...
\begin{proof}
	...
	\begin{aligned}
		...
		&= \sum_{i=1}^{1} \left(\sqrt{\frac{j-1}{j}} a_i- a_i\right)^2 + \sum_{i=2}^{\infty} \left(\sqrt{\frac{1}{j}} b^j_i \right)^2 \\
	...
	\begin{aligned}
		...
		&= \sum_{i=1}^{\infty} i^2 \left(\sqrt{\frac{j-1}{j}} a_i \right)^2 + \sum_{i=1}^{\infty} i^2 \left(\sqrt{\frac{1}{j}} b^j_i\right)^2 \\
