...
\begin{document}
	...
	\begin{proof}
		...
		\begin{equation}
			...
			\end{aligned}
		\end{equation}
		TODO: prove that the Euler-Lagrange equations imply Hamilton's equations
		...
		TODO: prove the converse. We have shown \ref{LM} implies both \ref{NM} and \ref{HM}, and therefore its equivalence.
	\end{proof}
	\begin{thrm}
